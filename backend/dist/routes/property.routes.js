...
router.post("/", auth_middleware_1.authenticateToken, (0, parser_1.jsonParser)("data"), (0, role_1.roleChecker)(["agent", "admin"], "Agent only can post new property!"), property_controller_1.default.createProperty);
