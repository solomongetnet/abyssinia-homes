...
("./_components/properties-container");
const Admin_UsersPage = () => {
    ...
    <div className="space-y-10">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground">
          {totalPropertiesCount} Users Found
        </p>
      </header>
      ...
      <main
        ...
        data-aos="fade-up"
      >
        <UsersContainer setTotalPropertiesCount={setTotalPropertiesCount} />
      </main>
    </div>
  );
};

export default Admin_UsersPage;
